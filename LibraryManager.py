...
books_list.append("Data Strucuture And Algorithims")
authors_set.add("Jane Doe")
books_dict["Data Structure And Algorithims"] = "Jane Doe"

books_list.append("Machine Learning Basics")
authors_set.add("Alice Johnson")
books_dict["MAchine Learnign Basics"] = "Alice Johnson"
...
if remove_title in books_list:
    ...
    books_title.remove (remove_title) 
